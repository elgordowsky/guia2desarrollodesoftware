...
public class Alcancia {
    ...
    public int obtenerDenominacionMasNumerosa() {
        ...
        if (numeroMonedas50 >= numeroMonedas100 && numeroMonedas50 >= numeroMonedas200 &&
                numeroMonedas50 >= numeroMonedas500 && numeroMonedas50 >= numeroMonedas1000) {
            return 50;
        } else if (numeroMonedas100 >= numeroMonedas200 && numeroMonedas100 >= numeroMonedas500 &&
                numeroMonedas100 >= numeroMonedas1000) {
            return 100;
        } else if (numeroMonedas200 >= numeroMonedas500 && numeroMonedas200 >= numeroMonedas1000) {
            return 200;
        } else if (numeroMonedas500 >= numeroMonedas1000) {
            return 500;
        } else {
            return 1000;
        }
